...
import 'package:loud_question/features/auth/application/coordinators/register_coordinator.dart'
    as _i47;
import 'package:loud_question/features/auth/auth.dart' as _i42;
import 'package:loud_question/features/common/common.dart' as _i33;
import 'package:loud_question/features/common/domain/domain.dart' as _i25;
...
import 'package:loud_question/repositories/interfaces/account_repository.dart'
    as _i31;
import 'package:loud_question/repositories/interfaces/interfaces.dart' as _i24;
...
import 'package:loud_question/repositories/interfaces/user_repository.dart'
    as _i27;
import 'package:loud_question/utils/server_settings.dart' as _i19;
import 'package:problem_details/problem_details.dart' as _i7;
import 'package:shared_preferences/shared_preferences.dart' as _i20;

import '../../../env/env_module.dart' as _i48;
import '../router/router.dart' as _i49;
import '../third_party/dio_module.dart' as _i50;
import '../third_party/shared_preferences_module.dart' as _i51;
...
Future<_i1.GetIt> init(
  ...
  gh.singleton<_i6.JsonConverter<_i11.LogOutResponse, Map<String, Object?>>>(
  ...
  gh.singleton<_i6.JsonConverter<_i15.LogInResponse, Map<String, Object?>>>(
      _i16.LogInResponseJsonConverter());
  await gh.singletonAsync<_i17.ServerExceptionProvider>(
    () => _i18.ProdServerExceptionProvider.create(),
    preResolve: true,
  );
  gh.singleton<_i19.ServerSettings>(envModule.serverSettings);
  await gh.factoryAsync<_i20.SharedPreferences>(
    () => sharedPreferencesModule.prefs,
    preResolve: true,
  );
  gh.singleton<_i21.TokenRepository>(
      _i22.ProdTokenRepository(prefs: gh<_i20.SharedPreferences>()));
  await gh.singletonAsync<_i23.TokenService>(
    () {
      final i = _i23.TokenService(
        dio: gh<_i3.Dio>(),
  ...
  gh.singleton<_i25.UserProvider>(_i26.ProdUserProvider(
    gh<_i3.Dio>(),
    gh<_i19.ServerSettings>(),
  ));
  gh.singleton<_i27.UserRepository>(
      _i28.ProdUserRepository(prefs: gh<_i20.SharedPreferences>()));
  gh.singleton<_i29.UserService>(_i29.UserService(
    userRepository: gh<_i24.UserRepository>(),
    userProvider: gh<_i30.UserProvider>(),
  ));
  gh.singleton<_i31.AccountRepository>(
      _i32.ProdAccountRepository(prefs: gh<_i20.SharedPreferences>()));
  gh.singleton<_i33.AuthExceptionProvider>(
      _i34.ProdAuthExceptionProvider(gh<_i33.ServerExceptionProvider>()));
  gh.singleton<_i25.AuthProvider>(_i35.ProdAuthProvider(
    gh<_i3.Dio>(),
    gh<_i19.ServerSettings>(),
  ));
  await gh.singletonAsync<_i36.AuthService>(
    () {
      final i = _i36.AuthService(
        authProvider: gh<_i37.AuthProvider>(),
        authExceptionProvider: gh<_i38.AuthExceptionProvider>(),
  ...
  gh.factory<_i39.HomeBloc>(
      () => _i39.HomeBloc(authService: gh<_i33.AuthService>()));
  gh.singleton<_i40.LogInCoordinator>(
    _i41.ProdLogInCoordinator(
      goRouter: gh<_i5.GoRouter>(),
      authService: gh<_i36.AuthService>(),
    )..init(),
    dispose: (i) => i.dispose(),
  );
  gh.singleton<_i42.RegisterCoordinator>(
    _i43.ProdRegisterCoordinator(
      goRouter: gh<_i5.GoRouter>(),
      authService: gh<_i36.AuthService>(),
    )..init(),
    dispose: (i) => i.dispose(),
  ...
  gh.factory<_i44.LogInBloc>(() => _i44.LogInBloc(
        logInCoordinator: gh<_i45.LogInCoordinator>(),
        authService: gh<_i36.AuthService>(),
      ));
  gh.factory<_i46.RegisterBloc>(() => _i46.RegisterBloc(
        registerCoordinator: gh<_i47.RegisterCoordinator>(),
        authService: gh<_i33.AuthService>(),
      ));
  return getIt;
}

class _$EnvModule extends _i48.EnvModule {}
