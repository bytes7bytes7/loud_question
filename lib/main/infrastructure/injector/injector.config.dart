...
import 'package:loud_question/features/auth/application/coordinators/register_coordinator.dart'
    as _i78;
import 'package:loud_question/features/auth/auth.dart' as _i70;
...
import '../../../env/env_module.dart' as _i79;
import '../router/router.dart' as _i80;
import '../third_party/dio_module.dart' as _i81;
import '../third_party/shared_preferences_module.dart' as _i82;
...
Future<_i1.GetIt> init(
  ...
  gh.singleton<_i8.JsonConverter<_i11.LogInResponse, Map<String, Object?>>>(
  ...
  gh.singleton<_i8.JsonConverter<_i15.JoinLobbyResponse, Map<String, Object?>>>(
  ...
  gh.singleton<
          _i8.JsonConverter<_i23.VerifyTokenResponse, Map<String, Object?>>>(
  ...
  gh.singleton<_i8.JsonConverter<_i27.GetLobbyResponse, Map<String, Object?>>>(
      _i28.GetLobbyResponseJsonConverter());
  ...
  gh.singleton<_i62.ListenGameStateProvider>(
    _i63.ProdListenGameStateProvider(gameProvider: gh<_i58.GameProvider>()),
    dispose: (i) => i.stop(),
  );
  gh.singleton<_i53.LobbyProvider>(_i64.ProdLobbyProvider(
    gh<_i3.Dio>(),
    gh<_i33.ServerSettings>(),
  ));
  gh.singleton<_i38.LobbyRepository>(
      _i65.ProdLobbyRepository(prefs: gh<_i34.SharedPreferences>()));
  gh.singleton<_i66.LobbyService>(_i66.LobbyService(
    lobbyRepository: gh<_i38.LobbyRepository>(),
    lobbyProvider: gh<_i67.LobbyProvider>(),
  ));
  gh.singleton<_i68.LogInCoordinator>(
    _i69.ProdLogInCoordinator(
      goRouter: gh<_i5.GoRouter>(),
      authService: gh<_i50.AuthService>(),
    )..init(),
    dispose: (i) => i.dispose(),
  );
  gh.singleton<_i70.RegisterCoordinator>(
    _i71.ProdRegisterCoordinator(
      goRouter: gh<_i5.GoRouter>(),
      authService: gh<_i50.AuthService>(),
    )..init(),
    dispose: (i) => i.dispose(),
  ...
  gh.factory<_i72.HomeBloc>(() => _i72.HomeBloc(
        ...
        coordinator: gh<_i73.HomeCoordinator>(),
      ));
  gh.factory<_i74.LobbyBloc>(() => _i74.LobbyBloc(
        lobbyService: gh<_i53.LobbyService>(),
        userService: gh<_i39.UserService>(),
        gameService: gh<_i53.GameService>(),
        accountRepository: gh<_i45.AccountRepository>(),
        listenGameStateProvider: gh<_i53.ListenGameStateProvider>(),
      ));
  gh.factory<_i75.LogInBloc>(() => _i75.LogInBloc(
        logInCoordinator: gh<_i76.LogInCoordinator>(),
        authService: gh<_i50.AuthService>(),
      ));
  gh.factory<_i77.RegisterBloc>(() => _i77.RegisterBloc(
        registerCoordinator: gh<_i78.RegisterCoordinator>(),
        authService: gh<_i47.AuthService>(),
      ));
  return getIt;
}

class _$EnvModule extends _i79.EnvModule {}
