...
import 'package:loud_question/features/auth/application/coordinators/register_coordinator.dart'
    as _i87;
import 'package:loud_question/features/auth/auth.dart' as _i76;
...
import '../third_party/dio_module.dart' as _i90;
import '../third_party/shared_preferences_module.dart' as _i91;
...
Future<_i1.GetIt> init(
  ...
  gh.singleton<_i65.HomeProvider>(_i66.ProdHomeProvider(
    gh<_i5.Dio>(),
    gh<_i39.ServerSettings>(),
  ));
  gh.singleton<_i67.HomeService>(
      _i67.HomeService(homeProvider: gh<_i65.HomeProvider>()));
  gh.factory<_i68.ListenGameStateProvider>(() =>
      _i69.ProdListenGameStateProvider(gameProvider: gh<_i64.GameProvider>()));
  gh.singleton<_i59.LobbyProvider>(_i70.ProdLobbyProvider(
    gh<_i5.Dio>(),
    gh<_i39.ServerSettings>(),
  ));
  gh.singleton<_i44.LobbyRepository>(
      _i71.ProdLobbyRepository(prefs: gh<_i40.SharedPreferences>()));
  gh.singleton<_i72.LobbyService>(_i72.LobbyService(
    lobbyRepository: gh<_i44.LobbyRepository>(),
    lobbyProvider: gh<_i73.LobbyProvider>(),
  ));
  gh.singleton<_i74.LogInCoordinator>(
  ...
  gh.singleton<_i76.RegisterCoordinator>(
    _i77.ProdRegisterCoordinator(
      goRouter: gh<_i7.GoRouter>(),
      authService: gh<_i56.AuthService>(),
    )..init(),
    dispose: (i) => i.dispose(),
  ...
  gh.factory<_i78.HomeBloc>(() => _i78.HomeBloc(
        ...
        homeService: gh<_i67.HomeService>(),
        userService: gh<_i45.UserService>(),
        coordinator: gh<_i79.HomeCoordinator>(),
      ));
  gh.factory<_i80.ListenLobbyProvider>(() =>
      _i81.ProdListenLobbyProvider(lobbyProvider: gh<_i73.LobbyProvider>()));
  gh.factory<_i82.LobbyBloc>(() => _i82.LobbyBloc(
        lobbyService: gh<_i59.LobbyService>(),
        userService: gh<_i45.UserService>(),
        gameService: gh<_i59.GameService>(),
        accountRepository: gh<_i51.AccountRepository>(),
        dateTimeProvider: gh<_i83.DateTimeProvider>(),
        listenGameStateProvider: gh<_i59.ListenGameStateProvider>(),
        listenLobbyProvider: gh<_i59.ListenLobbyProvider>(),
      ));
  gh.factory<_i84.LogInBloc>(() => _i84.LogInBloc(
        logInCoordinator: gh<_i85.LogInCoordinator>(),
        authService: gh<_i56.AuthService>(),
      ));
  gh.factory<_i86.RegisterBloc>(() => _i86.RegisterBloc(
        registerCoordinator: gh<_i87.RegisterCoordinator>(),
        authService: gh<_i53.AuthService>(),
      ));
  return getIt;
}

class _$EnvModule extends _i88.EnvModule {}
